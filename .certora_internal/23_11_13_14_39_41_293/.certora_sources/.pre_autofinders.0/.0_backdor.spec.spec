...
/** @title Verificar que backdoor no revierte con un valor distinto de 6912213124124532 */
rule backdoorDoesNotRevertNormally(uint256 x) {
    env e;

    // Asegurar que x no sea el valor que activa la reversión
    require distinct(x, 6912213124124532);
...
/** @title Verificar que backdoor revierte con el valor 6912213124124532 */
